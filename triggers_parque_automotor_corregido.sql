-- =====================================================
-- TRIGGERS COMPLETOS PARA PARQUE AUTOMOTOR - CORREGIDO
-- =====================================================
-- Archivo: triggers_parque_automotor_corregido.sql
-- Fecha: 2025-01-20
...
-- Versión: 2.1 - Corregido para usar la estructura real de la base de datos
...
CREATE INDEX IF NOT EXISTS idx_alertas_historial ON alertas_vencimiento(id_historial);
CREATE INDEX IF NOT EXISTS idx_alertas_tipo ON alertas_vencimiento(tipo_alerta);
CREATE INDEX IF NOT EXISTS idx_alertas_fecha ON alertas_vencimiento(fecha_alerta);
CREATE INDEX IF NOT EXISTS idx_alertas_notificado ON alertas_vencimiento(notificado);
...
CREATE INDEX IF NOT EXISTS idx_historial_estado ON historial_vencimientos(estado_documento);
...
CREATE INDEX IF NOT EXISTS idx_kilometraje_tipo ON kilometraje_vehiculos(tipo_registro);
...
SELECT 'Triggers corregidos para parque automotor creados exitosamente' as mensaje;

-- =====================================================
-- INSTRUCCIONES DE USO
-- =====================================================
/*
Este archivo contiene los triggers CORREGIDOS para el sistema de parque automotor:
...
4. ÍNDICES: Optimizan el rendimiento usando columnas reales
...
2. Ejecutar: SOURCE /ruta/al/archivo/triggers_parque_automotor_corregido.sql
3. Verificar que no haya errores en la ejecución

NOTA: Este archivo corrige los errores de estructura de la versión anterior
y se adapta a la arquitectura real definida en la documentación del sistema.
*/