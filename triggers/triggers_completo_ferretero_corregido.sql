-- =====================================================
-- SISTEMA DE TRIGGERS PARA FERRETERO - VERSIÓN CORREGIDA
-- =====================================================
-- Archivo: triggers_completo_ferretero_corregido.sql
-- Descripción: Sistema completo de triggers para gestión automática de stock
-- CORRIGE: Error de columna 'cantidad_entrada' no encontrada en stock_general
-- Fecha: 2024
...
-- 3. Ejecutar este archivo completo: mysql -u root -p capired < triggers_completo_ferretero_corregido.sql
-- =====================================================
...
-- COLUMNAS CORRECTAS: id, codigo_material, descripcion, cantidad_disponible, cantidad_minima, fecha_actualizacion, activo
...
-- COLUMNAS CORRECTAS: id, codigo_material, cantidad_entrada, fecha_entrada, observaciones
...
-- TABLA ORIGEN: entradas_stock (tiene columna cantidad_entrada)
-- TABLA DESTINO: stock_general (tiene columna cantidad_disponible)
-- =====================================================
CREATE TRIGGER actualizar_stock_entrada
AFTER INSERT ON entradas_stock
FOR EACH ROW
BEGIN
    -- CORRECCIÓN: Usar NEW.cantidad_ingresada de entradas_stock para actualizar cantidad_disponible en stock_general
    ...
    VALUES (
        'ENTRADA_STOCK',
        CONCAT('Entrada de stock: ', NEW.cantidad_ingresada, ' unidades de ', NEW.material)
    );
END//
...
-- TABLA ORIGEN: ferretero (tiene columnas silicona, grapas_negras, etc.)
-- TABLA DESTINO: stock_general (tiene columna cantidad_disponible)
-- =====================================================
...
FOR EACH ROW
BEGIN
    -- CORRECCIÓN: Usar cantidad_disponible de stock_general (NO cantidad_entrada)
...
FOR EACH ROW
BEGIN
    -- CORRECCIÓN: Usar cantidad_disponible y cantidad_minima de stock_general
...
BEGIN
    ...
    -- CORRECCIÓN: Obtener cantidad_disponible de stock_general
...
-- =====================================================
-- FIN DEL ARCHIVO CORREGIDO
-- =====================================================
SELECT 'Sistema de triggers corregido instalado correctamente!' AS mensaje_final;