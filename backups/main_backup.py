...
def obtener_indicadores_cumplimiento():
    try:
        #print("Iniciando cálculo de indicadores de cumplimiento")
        ...
        if fecha:
            ...
            fecha = get_bogota_datetime().date()
        
        #print(f"Fecha a procesar: {fecha}")
        ...
        query_asistencia = """
            ...
            GROUP BY a.super
        """
        #print(f"Ejecutando query de asistencia: {query_asistencia}")
        ...
        query_preoperacional = """
            ...
            GROUP BY supervisor
        """
       # print(f"Ejecutando query de preoperacional: {query_preoperacional}")
       ...
       # print(f"Preoperacional por supervisor: {preop_por_supervisor}")
        ...
        for supervisor in supervisores:
            if supervisor:  # Ignorar supervisores nulos
                ...
                #print(f"Indicador calculado para {supervisor}: {indicador}")
        ...
        #print(f"Indicadores finales calculados: {indicadores}")
