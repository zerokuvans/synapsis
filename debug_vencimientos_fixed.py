...
Versión corregida que maneja fechas '0000-00-00'
"""
...
def conectar_bd():
    ...
    try:
        connection = mysql.connector.connect(
            ...
            database='capired',
            sql_mode=''  # Permitir fechas '0000-00-00'
        )
        return connection
...
def verificar_tabla_soat(cursor):
    ...
    # Registros con fecha válida (no NULL y no '0000-00-00')
    cursor.execute("""
    ...
    cursor.execute("""
        ...
        OR fecha_vencimiento = '0000-00-00 00:00:00'
    """)
    ...
    cursor.execute("""
        SELECT s.placa_vehiculo, s.fecha_vencimiento, r.nombre_completo
        FROM mpa_soat s
        ...
        AND s.fecha_vencimiento != '0000-00-00 00:00:00'
        LIMIT 5
    """)
...
def verificar_tabla_tecnico(cursor):
    ...
    # Ejemplos de registros válidos
    cursor.execute("""
        SELECT t.placa_vehiculo, t.fecha_vencimiento, r.nombre_completo
        ...
        AND t.fecha_vencimiento != '0000-00-00'
        AND t.fecha_vencimiento != '0000-00-00 00:00:00'
        LIMIT 5
    """)
    ejemplos = cursor.fetchall()
    print(f"📋 Ejemplos de registros válidos:")
...
def verificar_tabla_licencias(cursor):
    ...
    # Ejemplos de registros válidos
    cursor.execute("""
        SELECT l.fecha_vencimiento, r.nombre_completo
        ...
        AND l.fecha_vencimiento != '0000-00-00 00:00:00'
        LIMIT 5
    """)
    ejemplos = cursor.fetchall()
    print(f"📋 Ejemplos de registros válidos:")
